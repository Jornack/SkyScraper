...
public class SaveJDialog extends JDialog implements ActionListener
{
    ...
    public SaveJDialog(Frame parent, String filename)
    {
        ...
        spring.putConstraint(SpringLayout.NORTH, saveTxtField, 10,
                SpringLayout.NORTH, panel);
        spring.putConstraint(SpringLayout.WEST, saveTxtField, 5,
                SpringLayout.WEST, panel);
        spring.putConstraint(SpringLayout.EAST, saveTxtField, -5,
        ...
        spring.putConstraint(SpringLayout.NORTH, okBtn, 4, SpringLayout.SOUTH,
                saveTxtField);
        spring.putConstraint(SpringLayout.EAST, okBtn, 0, SpringLayout.EAST,
                saveTxtField);
        ...
        spring.putConstraint(SpringLayout.NORTH, cancelBtn, 4,
                SpringLayout.SOUTH, saveTxtField);
        spring.
                putConstraint(SpringLayout.EAST, cancelBtn, -5,
                        SpringLayout.WEST, okBtn);
        //spring.putConstraint(SpringLayout.EAST, okBtn, -10, SpringLayout.EAST, panel);
        panel.add(cancelBtn);
    ...
    public void actionPerformed(ActionEvent arg0)
    {
        if (arg0.getActionCommand().equals("CANCEL"))
        {
            PreferenceManager.getPreferences().put(
                    PreferenceManager.SAVE_FILENAME, oldValue);
        } else
        {
            PreferenceManager.getPreferences().put(
                    PreferenceManager.SAVE_FILENAME, saveTxtField.getText());
            PreferenceManager.getPreferences().put(PreferenceManager.SAVE,
                    "true");
        }
