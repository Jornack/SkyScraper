...
/**
 * <p>
 * Title:	SkyScraper</p><br>
 * <p>
 * Description:	Displays NeuroSky EEG data in a realtime BarChart with the
 * ability to save and generate LineCharts to JPG/PNG</p><br>
 *
 * @author Jornack
 *
 * $Author: Jornack $
 */
public class SkyScraper extends ApplicationFrame implements ActionListener,
        MouseListener
{
    ...
    public SkyScraper(String title)
    {
        ...
        spring.
                putConstraint(SpringLayout.EAST, debugPanel, 0,
                        SpringLayout.EAST, content);
        spring.
                putConstraint(SpringLayout.WEST, debugPanel, 0,
                        SpringLayout.WEST, content);
        spring.putConstraint(SpringLayout.SOUTH, debugPanel, 0,
                SpringLayout.SOUTH, content);
        ...
        spring.putConstraint(SpringLayout.NORTH, buttonPanel, 15,
                SpringLayout.NORTH, content);
        spring.putConstraint(SpringLayout.EAST, buttonPanel, -5,
                SpringLayout.EAST, content);
        spring.putConstraint(SpringLayout.WEST, buttonPanel, -125,
                SpringLayout.EAST, buttonPanel);

        JFreeChart eSenseBarChart = createESenseBarChart(altDataSet, "",
                "eSense");
        JFreeChart eegPowerBarChart = createEEGPowerBarChart(wavesDataSet, "",
                "eegPower");
        ...
        spring.putConstraint(SpringLayout.NORTH, eSenseChartPanel, 5,
                SpringLayout.NORTH, content);
        spring.putConstraint(SpringLayout.WEST, eSenseChartPanel, 5,
                SpringLayout.WEST, content);
        spring.putConstraint(SpringLayout.EAST, eSenseChartPanel, 275,
                SpringLayout.WEST, eSenseChartPanel);
        spring.putConstraint(SpringLayout.SOUTH, eSenseChartPanel, -5,
                SpringLayout.NORTH, debugPanel);

        eegPowerChartPanel = new ChartPanel(eegPowerBarChart);
        spring.putConstraint(SpringLayout.NORTH, eegPowerChartPanel, 5,
                SpringLayout.NORTH, content);
        spring.putConstraint(SpringLayout.WEST, eegPowerChartPanel, 5,
                SpringLayout.EAST, eSenseChartPanel);
        spring.putConstraint(SpringLayout.EAST, eegPowerChartPanel, -5,
                SpringLayout.WEST, buttonPanel);
        spring.putConstraint(SpringLayout.SOUTH, eegPowerChartPanel, -5,
                SpringLayout.NORTH, debugPanel);
    ...
    private JScrollPane createdebugPanel()
    {
        ...
        spring.putConstraint(SpringLayout.NORTH, debugArea, 5,
                SpringLayout.NORTH, panel);
        spring.putConstraint(SpringLayout.WEST, debugArea, 5, SpringLayout.WEST,
                panel);
        spring.
                putConstraint(SpringLayout.EAST, debugArea, -5,
                        SpringLayout.EAST, panel);
        spring.putConstraint(SpringLayout.SOUTH, debugArea, -5,
    ...
    private JPanel createButtonPanel()
    {
        ...
        spring.putConstraint(SpringLayout.NORTH, signalLabel, 10,
                SpringLayout.NORTH, panel);
        spring.putConstraint(SpringLayout.WEST, signalLabel, 50,
                SpringLayout.WEST, panel);
        panel.add(signalLabel);

        setSignalStrength(new SignalStrengthJPanel());

        spring.putConstraint(SpringLayout.NORTH, getSignalStrength(), 0,
                SpringLayout.NORTH, signalLabel);
        spring.putConstraint(SpringLayout.WEST, getSignalStrength(), 5,
                SpringLayout.EAST, signalLabel);
        panel.add(getSignalStrength());

        JButton connectBtn = new JButton("Connect");
        connectBtn.setActionCommand(ACTION_CMD_CONNECT);
        connectBtn.addActionListener(this);
        spring.putConstraint(SpringLayout.NORTH, connectBtn, 10,
                SpringLayout.SOUTH, signalLabel);
        spring.
                putConstraint(SpringLayout.WEST, connectBtn, 5,
                        SpringLayout.WEST, panel);
        spring.putConstraint(SpringLayout.EAST, connectBtn, -10,
                SpringLayout.EAST, panel);
        ...
        spring.
                putConstraint(SpringLayout.NORTH, saveBtn, 10,
                        SpringLayout.SOUTH, connectBtn);
        spring.putConstraint(SpringLayout.WEST, saveBtn, 5, SpringLayout.WEST,
                panel);
        spring.putConstraint(SpringLayout.EAST, saveBtn, -10, SpringLayout.EAST,
                panel);
        panel.add(saveBtn);
        ...
        spring.putConstraint(SpringLayout.NORTH, generateBtn, 10,
                SpringLayout.SOUTH, saveBtn);
        spring.putConstraint(SpringLayout.WEST, generateBtn, 5,
                SpringLayout.WEST, panel);
        spring.putConstraint(SpringLayout.EAST, generateBtn, -10,
                SpringLayout.EAST, panel);
        ...
        spring.putConstraint(SpringLayout.NORTH, excelBtn, 10,
                SpringLayout.SOUTH, generateBtn);
        spring.putConstraint(SpringLayout.WEST, excelBtn, 5, SpringLayout.WEST,
                panel);
        spring.
                putConstraint(SpringLayout.EAST, excelBtn, -10,
                        SpringLayout.EAST, panel);
        panel.add(excelBtn);
        ...
        spring.putConstraint(SpringLayout.NORTH, prefsbtn, 10,
                SpringLayout.SOUTH, excelBtn);
        spring.putConstraint(SpringLayout.WEST, prefsbtn, 5, SpringLayout.WEST,
                panel);
        spring.
                putConstraint(SpringLayout.EAST, prefsbtn, -10,
                        SpringLayout.EAST, panel);
        panel.add(prefsbtn);
...
//		//panel.add(signalStrengthText);
        ...
        group.add(barBtn);
        group.add(lineBtn);
        spring.putConstraint(SpringLayout.WEST, barBtn, 0, SpringLayout.WEST,
                prefsbtn);
        spring.putConstraint(SpringLayout.NORTH, barBtn, 5, SpringLayout.SOUTH,
                prefsbtn);
        spring.putConstraint(SpringLayout.WEST, lineBtn, 0, SpringLayout.WEST,
                barBtn);
        spring.putConstraint(SpringLayout.NORTH, lineBtn, 5, SpringLayout.SOUTH,
                barBtn);
     ...
     * @return The chart.
     */
    private JFreeChart createESenseBarChart(final CategoryDataset dataset,
            String title, String domain)
    {
...
//        renderer.setSeriesPaint(2, gp2);
     ...
     * @return The chart.
     */
    private JFreeChart createEEGPowerBarChart(final CategoryDataset dataset,
            String title, String domain)
    {
    ...
    private JFreeChart createEEGPowerLineChart(XYDataset dataset)
    {
        ...
        renderer.setSeriesStroke(INDEX_DELTASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_THETASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_LOWALPHASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_HIGHALPHASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_LOWBETASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_HIGHBETASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_LOWGAMMASERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(INDEX_HIGHGAMASERIES, new BasicStroke(
                LINE_THINKNESS));
    ...
    private JFreeChart createESenseLineChart(XYDataset dataset)
    {
        ...
        XYItemRenderer renderer = plot.getRenderer();
        renderer.setSeriesStroke(this.INDEX_ATTENTIONSERIES, new BasicStroke(
                LINE_THINKNESS));
        renderer.setSeriesStroke(this.INDEX_MEDITATIONSERIES, new BasicStroke(
                LINE_THINKNESS));
    ...
    public void actionPerformed(ActionEvent arg0)
    {
        ...
        if (arg0.getActionCommand().equals(ACTION_CMD_CONNECT))
        {
            ...
            this.thinkGearHandlerSwingWorker.setSignalStrength(
                    this.signalStrength);
        ...
        } else if (arg0.getActionCommand().equals(ACTION_CMD_SAVE))
        {
            ...
            String filename = "skyskraper." + fmt.format(new Date()).toString()
                    + ".json";
            ...
            if (PreferenceManager.getPreferences().get(PreferenceManager.SAVE,
                    "false").equals("true"))
            {
                this.thinkGearHandlerSwingWorker.setFilename(PreferenceManager.
                        getPreferences().get("skyskraper.save.filename",
                                filename));
    ...
    private void switchChart(boolean type)
    {
        if (type != charType)
        {
            ...
            if (type == CHART_TYPE_BAR)
            {
                ...
                eSenseChartPanel.setChart(createESenseBarChart(altDataSet, "",
                        "eSense"));
                eegPowerChartPanel.setChart(createEEGPowerBarChart(wavesDataSet,
                        "", "eegPower"));
    ...
    private class ThinkGearHandlerSwingWorker extends SwingWorker<Void, Void>
    {
        ...
        protected Void doInBackground()
        {
            ...
            while (!getConnector().isConnected() && counter
                    < MAX_CONNECT_RETRIES)
            {
                ...
                while (getConnector().isDataAvailable())
                {
                    try
                    {
                        ...
                        if (!json.isNull("poorSignalLevel"))
                        {
                            ...
                            strength = (int) (((double) strength / (double) 200)
                                    * 100);
                        ...
                        if (!json.isNull("eSense"))
                        {
                            ...
                            getAltDataSet().setValue(esense.getInt("attention"),
                                    "Attention", "");
                            getAltDataSet().
                                    setValue(esense.getInt("meditation"),
                                            "Meditation", "");
                            getAttentionSeries().add(now, (double) esense.
                                    getInt("attention"));
                            getMeditationSeries().add(now, (double) esense.
                                    getInt("meditation"));
                        }
                        ...
                        if (!json.isNull("eegPower"))
                        {
                            ...
                            getWavesDataSet().setValue(eegPower.getInt("delta"),
                                    "delta", "");
                            getWavesDataSet().setValue(eegPower.getInt("theta"),
                                    "theta", "");
                            getWavesDataSet().setValue(eegPower.getInt(
                                    "lowAlpha"), "lowAlpha", "");
                            getWavesDataSet().setValue(eegPower.getInt(
                                    "highAlpha"), "highAlpha", "");
                            getWavesDataSet().setValue(eegPower.
                                    getInt("lowBeta"), "lowBeta", "");
                            getWavesDataSet().setValue(eegPower.getInt(
                                    "highBeta"), "highBeta", "");
                            getWavesDataSet().setValue(eegPower.getInt(
                                    "lowGamma"), "lowGamma", "");
                            ...
                            getDeltaSeries().add(now, (double) eegPower.getInt(
                                    "delta"));
                            getThetaSeries().add(now, (double) eegPower.getInt(
                                    "theta"));
                            getLowAlphaSeries().add(now, (double) eegPower.
                                    getInt("lowAlpha"));
                            getHighAlphaSeries().add(now, (double) eegPower.
                                    getInt("highAlpha"));
                            getLowBetaSeries().add(now, (double) eegPower.
                                    getInt("lowBeta"));
                            getHighBetaSeries().add(now, (double) eegPower.
                                    getInt("highBeta"));
                            getLowGammaSeries().add(now, (double) eegPower.
                                    getInt("lowGamma"));
