...
public class ThinkGearJSONReader extends JSONReaderAbstract{
	...
	public ThinkGearJSONReader(){
		this.setHost(PreferenceManager.getPreferences().get(PreferenceManager.THINKGEAR_DEFAULT_HOST, DEFAULT_HOST));
		this.setPort(PreferenceManager.getPreferences().getInt(PreferenceManager.THINKGEAR_DEFAULT_PORT, DEFAULT_PORT));
	}
	...
	public void connect() throws IOException {
		...
		if (channel == null || !channel.isConnected()) {
			...
			this.channel = SocketChannel.open( new InetSocketAddress(this.getHost(), this.getPort()));
			
			boolean rawOutput = PreferenceManager.getPreferences().getBoolean(PreferenceManager.THINKGEAR_RAW_OUTPUT, false);
